...
class CompraPolicy
{
    ...
    {
        return $user->hasAnyRole(roles: ['super admin', 'admin', 'Funcionario-Compras','Funcionario Almacen']);
    }
    ...
    {
        //
        return $user->hasAnyRole(roles: ['super admin', 'admin', 'Funcionario-Compras']);
